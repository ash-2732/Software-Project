...
function SearchTeacher() {
  ...
  const handleSearch = () => {
    const endpoint = `http://${IP_ADDRESS}/founder/searchTeacher?search=${search}`;
    fetch(`${endpoint}`, {
      method: "GET",
      headers: {
              ...
              {users.map((teacher, index) => {
                return (
                  ...
                  >
                    ...
                    >
                      <div className="">
                        <h1 className="text-center font-semibold text-[18px]">Teacher Info</h1>
                        <div className="flex justify-between gap-3 border-t-[2px]">
                          ...
                          <div className="flex flex-col">
                            <h1>{teacher.name}</h1>
                            <h1>{teacher.batch}</h1>
                            <h1>{teacher.college}</h1>
                            <h1>{teacher.university}</h1>
