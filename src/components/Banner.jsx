          ...
          <div className="grid grid-cols-1 items-center gap-4  md:grid-cols-2">
            ...
            >
              <h1 className="text-2xl md:text-4xl ">
                Welcome everyone to our platform
              </h1>
            ...
            >
              <img
                src='https://wallpapers.com/images/hd/education-pictures-8h113rax6oc0lplx.jpg'
                alt="No image"
                className="max-auto w-full hover:drop-shadow-md p-10"
              />
            </div>
          </div>
        </section>
